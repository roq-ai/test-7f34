  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Test: Your gateway to a greener life. Explore our luxurious plant universe, engage with our community, and embrace the power of nature against a toxic world. Let's grow together!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwbGFudHN8ZW58MHx8fHwxNjk0MDg0NTYyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@nahilnaseer?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Nahil Naseer`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Test: Your gateway to a greener life. Explore our luxurious plant universe, engage with our community, and embrace the power of nature against a toxic world. Let's grow together!`}
            </Text>
            <Box
